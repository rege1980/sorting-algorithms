...
namespace sortingAlgorithms
{
    partial class Sorting
    {
        ...
        private void InitializeComponent()
        {
            ...
            labRand = new Label();
            bwProgress = new System.ComponentModel.BackgroundWorker();
            butSave = new Button();
            ...
            UDRand.Maximum = new decimal(new int[] { 20000000, 0, 0, 0 });
            ...
            bwProgress.ProgressChanged += ProgressChanged;
            // 
            // butSave
            // 
            butSave.Enabled = false;
            butSave.Location = new Point(534, 170);
            butSave.Name = "butSave";
            butSave.Size = new Size(90, 25);
            butSave.TabIndex = 14;
            butSave.Text = "Save to file";
            ...
            Text = "Sorting algorithms v0.2.1";
